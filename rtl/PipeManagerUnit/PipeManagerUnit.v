module pipe_manager_unit (
	...
	assign clear_EC 				= jumpOrBranch  | cleanPipe_C_o | loadWordStall ;
	assign clear_M 					= pauseCore;
	assign clear_W 					= waitRequest_M_o;

	assign stall_F 					= loadWordStall | fullPipeStall   | waitRequest_M_o | waitRequest_F_o | pauseCore;
	assign stall_D 					= loadWordStall | fullPipeStall   | waitRequest_M_o | 					pauseCore;
	assign stall_EC 				= 				  fullPipeStall   | waitRequest_M_o | 					pauseCore;
	assign stall_M 					= 				  fullPipeStall   | waitRequest_M_o ;
	assign stall_W 					= 				  fullPipeStall   ;

		
	assign stallStatus				=	stall_F 	| stall_D 	| stall_EC 	| 	stall_M 	| 	stall_W; 
endmodule