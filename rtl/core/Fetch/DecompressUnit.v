...
module decompress_unit(
    ...
    localparam REG_COMPRESSED_BASE       = 5'b01000; // X8 (s0)
                ...
                case(funct3)
                    ...
                    C1_LUI_ADDI16SP: begin
                        if (rd_rs1 == REG_SP) begin
                            ...
                            // C.LUI -> lui rd, imm20
                            // Correct 20-bit field: 15 sign bits + 5-bit compressedInst[6:2]
                    ...
                    C1_ALU_OPS: begin
                        ...
                        case(sub_select_rs1)
                            ...
                            default: begin // Sub-ops for C1 Register arithmetic
                                case(sub_select_rs2)
