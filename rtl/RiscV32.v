module RiscV32 (
	...
	register #(198) Execute_Reg (
        .clk(clk),
        .rst(rst),
        .enable(~stall_EC),
        .clear(clear_EC),
        .regIn( {instCountEn_D_o, ALUSrcAType_D_o, ALUSrcBType_D_o, ALUOpcode_D_o, memWrite_D_o, memRead_D_o, regWrite_D_o,funct3_D_o, jump_D_o, branch_D_o, writeBackSrcSelect_D_o, stageSignalValid_D_o, pause_D_o
				,PC_D_o, nextPC_D_o, rs1Data_D_o, rs2Data_D_o, immExtend_D_o, rd_D_o, rs1Addr_D_o, rs2Addr_D_o }),
        .regOut({instCountEn_E_i, ALUSrcAType_E_i, ALUSrcBType_E_i, ALUOpcode_E_i, memWrite_E_i, memRead_E_i, regWrite_E_i,funct3_E_i, jump_E_i, branch_E_i, writeBackSrcSelect_E_i, stageSignalValid_E_i, pause_E_i
	...
	assign pmCounterEn_C_i	=	{changePCSrc, stallStatus, loadStore};
	...
	assign	loadStore		=	(memRead_M_i	| 	memWrite_M_i) & (~stall_M);
 	...
 	memory_stage Memory(
		...
		.writeBackResult_M_o(writeBackResult_M_o),
	...
	register #(40) WriteBack_Reg (
        ...
        .enable(~stall_W),
        .clear(clear_W),
        .regIn( {instCountEn_M_o, regWrite_M_o, stageSignalValid_M_o
				 ,writeBackResult_M_o, rd_M_o}),
